...
const App: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="relative w-full min-h-[450vh] overflow-hidden bg-[#E8E4DC] text-[#1A1A1A]">
      <Cursor />
      ...
      <nav className="fixed inset-0 pointer-events-none z-50 p-8 md:p-12 mix-blend-multiply">
        ...
        <div className="absolute top-8 left-8 md:top-12 md:left-12 pointer-events-auto cursor-pointer">
           <motion.h1 
             ...
             className="font-serif-display text-xl md:text-2xl font-bold tracking-tight transition-colors duration-300 hover:text-[#F97316]"
           >
             Jayaram H
           </motion.h1>
        ...
        <div className="absolute top-8 right-8 md:top-12 md:right-12 flex flex-col items-end gap-2 pointer-events-auto">
          {['Work', 'About', 'Process', 'Contact'].map((item, i) => (
            <motion.a 
              ...
              className="group font-sans text-xs uppercase tracking-widest hover:text-[#0000EE] transition-colors relative"
              data-hoverable="true"
            >
              {item}
        ...
        <div className="absolute bottom-8 right-8 md:bottom-12 md:right-12 pointer-events-auto">
           <motion.a 
             ...
             className="font-serif-display text-lg md:text-xl italic hover:text-[#8B4513]"
             data-hoverable="true"
      ...
      <section className="relative h-[130vh] w-full bg-gradient-to-b from-[#E8E4DC] to-[#E8E4DC]">
           ...
           <div className="relative bg-[#FDFBF7] p-5 shadow-[8px_16px_30px_-10px_rgba(0,0,0,0.15)] w-64 transition-transform hover:scale-[1.02] duration-500 overflow-hidden bg-[linear-gradient(#00000005_1px,transparent_1px),linear-gradient(90deg,#00000005_1px,transparent_1px)] bg-[size:16px_16px]">
             ...
             <div className="relative z-10 mt-5 flex justify-between items-end">
                <div className="flex flex-col">
                    ...
                    <span className="font-mono text-[9px] text-[#3D5A3D] bg-[#3D5A3D]/10 px-1.5 py-0.5 rounded-sm w-fit mt-0.5">V1.2</span>
                </div>
                <span className="font-hand text-xl text-[#1A1A1A] -rotate-3 transform translate-y-1">Jayaram H.</span>
             </div>
        ...
        <CollageItem key={`hero-quote-${layoutKey}`} containerRef={containerRef} x="15%" y="60%" speed={0.6} rotation={-2} zIndex={10}>
          <div className="max-w-sm">
            <p className="font-serif-display text-xl md:text-2xl italic leading-tight text-[#1A1A1A]">
      ...
      <section id="work" className="relative w-full h-[280vh]">
        ...
        <CollageItem key={`work-header-${layoutKey}`} containerRef={containerRef} x="5%" y="5%" zIndex={5}>
           <h3 className="font-serif-display text-4xl md:text-5xl italic text-[#3D5A3D]">Work Logs</h3>
          ...
          return (
            ...
            >
              ...
              >
                ...
                {/* Content */}
                <div>
                  <h4 className="font-serif-display text-2xl font-medium leading-none text-[#1A1A1A] group-hover:text-[#0000EE] transition-colors">{project.title}</h4>
                  <p className="font-sans text-[11px] mt-2 text-gray-600 leading-relaxed border-l-2 border-gray-300 pl-3 group-hover:border-[#0000EE] transition-colors">
                    {project.description}
                  </p>
                </div>
        ...
        <CollageItem key={`decor-3-${layoutKey}`} containerRef={containerRef} x="10%" y="80%" zIndex={1} speed={0.1}>
           <Crosshair className="w-8 h-8 text-[#0000EE] opacity-20" />
        </CollageItem>
        ...
        <CollageItem key={`decor-5-${layoutKey}`} containerRef={containerRef} x="85%" y="60%" zIndex={1}>
           <CircleScribble className="w-24 h-24 opacity-50 text-[#8B4513]" />
        </CollageItem>
      ...
      <section id="contact" className="relative h-[60vh] w-full flex flex-col items-center justify-center text-center">
         ...
         <div className="relative z-20">
            <h2 className="font-serif-display text-3xl md:text-5xl mb-6">Let's build something<br/><span className="italic text-[#8B4513]">tangible</span>.</h2>
            <div className="flex justify-center gap-8">
               <a href="#" className="font-mono text-xs border-b border-black hover:text-[#0000EE] hover:border-[#0000EE] transition-colors" data-hoverable="true">Instagram</a>
               <a href="#" className="font-mono text-xs border-b border-black hover:text-[#0000EE] hover:border-[#0000EE] transition-colors" data-hoverable="true">Twitter / X</a>
               <a href="#" className="font-mono text-xs border-b border-black hover:text-[#0000EE] hover:border-[#0000EE] transition-colors" data-hoverable="true">LinkedIn</a>
            </div>
         </div>
