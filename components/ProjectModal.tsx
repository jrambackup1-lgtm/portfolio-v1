...
const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose }) => {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="fixed inset-0 z-[20000] flex items-center justify-center p-4 md:p-8 bg-charcoal/60 backdrop-blur-sm"
      onClick={onClose}
    >
      <motion.div
        ...
        className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-paper shadow-2xl overflow-hidden flex flex-col md:flex-row cursor-auto"
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 relative flex flex-col">
          ...
          <div className="mb-6 flex justify-between items-start">
            <div>
              ...
              <h2 className="font-serif-display text-4xl md:text-5xl text-charcoal leading-none">{project.title}</h2>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8 border-t border-b border-gray-300 py-4">
            ...
            <div>
              ...
              <p className="font-sans text-sm font-bold text-accent-green">Fabricated</p>
            </div>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-dashed border-gray-400 flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className="group flex items-center gap-2 font-mono text-xs uppercase hover:text-accent-orange transition-colors"
              data-hoverable="true"
            >
