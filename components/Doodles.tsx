...
export const SwirlVine: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 200 200" className={`text-accent-green ${className}`} fill="none" xmlns="http://www.w3.org/2000/svg">
    <motion.path
...
export const CircleScribble: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 100 100" className={`text-accent-brown ${className}`} fill="none" xmlns="http://www.w3.org/2000/svg">
    <motion.path
...
export const StarSparkle: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 50 50" className={`text-charcoal ${className}`} fill="none" xmlns="http://www.w3.org/2000/svg">
    <motion.path
...
export const Underline: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 200 20" className={`text-accent-blue ${className}`} fill="none" preserveAspectRatio="none">
    <motion.path
